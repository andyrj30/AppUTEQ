package com.example.andres_dell.uteqdemo.utils.WebServ;
...
import com.example.andres_dell.uteqdemo.utils.WebServ.HttpRequest.HttpRequestException;
...
public class WebService extends AsyncTask<String, Long, String> {
    ...
    protected void onPreExecute() {
        ...
        progDailog.setMessage("Conectando con uteq.edu.ec...");
        progDailog.setIndeterminate(false);
        progDailog.setProgressStyle(ProgressDialog.BUTTON_POSITIVE);
        progDailog.show();
    }
    @Override
